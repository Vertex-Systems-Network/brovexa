...
describe('buildContextSelection', () => {
  ...
  it('excludes stale, conflicted and expired memory from optional context', () => {
    const selection = buildContextSelection({
      definition,
      workspaceId: workspaceA,
      userId: userA,
  ...
  it('fits required context first and deterministically ranks optional context', () => {
