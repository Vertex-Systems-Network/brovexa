export declare const authClientKindValues: readonly ['web', 'desktop', 'extension', 'api'];
export type AuthClientKind = (typeof authClientKindValues)[number];
export declare const authenticationMethodValues: readonly ['test', 'password', 'oidc', 'passkey'];
export type AuthenticationMethod = (typeof authenticationMethodValues)[number];
export declare const authenticationAssuranceValues: readonly ['single_factor', 'multi_factor'];
